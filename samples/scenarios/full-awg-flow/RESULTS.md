# Full AWG flow matrix results

## Diagrams

### Process train (demo stations)

![Process flow stations](flow-stations.svg)

![Station T / RH / W bars](flow-station-bars.svg)

Details: [`FLOW.md`](FLOW.md), [`stations.csv`](stations.csv).
...
```mermaid
xychart-beta
    title "Full AWG flow matrix — L/day vs ambient temperature"
